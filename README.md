...
> **Status: early development (phase 5 of 9).** The daemon publishes
...
> network topology. Control entities are phase 6. The roadmap and the
> design rationale live in [`CONCEPT.md`](CONCEPT.md), the design source
> of truth.
