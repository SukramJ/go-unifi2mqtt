...
**Last updated:** 2026-08-14 · **Status:** phases 0–1 done, phase 2 next
...
| **2** | `internal/coordinator` + MQTT publication, bridge LWT, change detection                                            | first topics on the broker        |
